(function (global, factory) {
   ...
   */
  const Color = function (initialValue) {
  ...
  Color.prototype.ansi = function (depth) {
    return this.cachedBitDepth || (this.cachedBitDepth = mapBitDepth(this.hex(), depth));
  };
  /**
   * The map implementation (provided by implementations)
   * @function hex
  ...
  Color.prototype.hex = function () {
    return this.cachedHex || (this.cachedHex = '#' + this.channels.map(i => i.toString(16).substring(0, 2).padStart(2, '0')).join(''));
  };
  /**
   * The map implementation (provided by implementations)
   * @function rgb
