  ...
  Space.prototype.getColors = function (medium) {
    switch (this.depth) {
      case (24, 32):
        return '*';
      case 16:
        throw new Error(`Unimplemented bit depth(${this.depth})`);
      case 8:
        return this.ansi256;
      case 4:
        return medium && medium.getColors() || this.ansi16;
      default:
